...
<h1 align="center" style="margin: 0; border-bottom: 0">omni-auth-supabase</h1>
  <p align="center">
    Angular authentication library providing Supabase integration for authentication flows, guards, and error handling.
    <br />
...
![License MIT](https://img.shields.io/npm/l/%40ngx-addons%2Fomni-auth-supabase)
![NPM Version](https://img.shields.io/npm/v/%40ngx-addons%2Fomni-auth-supabase)
